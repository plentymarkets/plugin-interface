 ...
 */
abstract class CSVResultConverterArrayAsJson extends \Plenty\Modules\Catalog\Services\Converter\ResultConverters\BaseResultConverter 

{
	...
	const OPTIONS_PATH = 'converter.csv-array-as-json';
