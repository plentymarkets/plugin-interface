<?php
namespace Plenty\Modules\Catalog\Services\UI\Assignments\Elements;
...
use Plenty\Modules\Catalog\Services\UI\Assignments\Elements\Base\BaseAssignment;

/**
 * Assignment Option of type: select
 */
abstract class SelectAssignment 
{
