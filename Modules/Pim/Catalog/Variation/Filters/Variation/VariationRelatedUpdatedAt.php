...
use Plenty\Modules\Pim\SearchService\Filter\VariationRelatedLastUpdatedAtFilter;

/**
 * Used to represent the VariationRelatedUpdatedAtFilter in both the catalog export and UI.
 */
abstract class VariationRelatedUpdatedAt implements \Plenty\Modules\Catalog\Contracts\Filters\CatalogFilterBuilderContract

{

	const KEY = 'variationRelatedUpdatedAt';
