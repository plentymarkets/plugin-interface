...
use Plenty\Modules\ContentBuilder\Factories\Settings\CheckboxSettingFactory as CoreCheckboxSettingFactory;

/**
 * Factory to define a checkbox in the widget settings.
 */
abstract class CheckboxSettingFactory 
{

	/**
	 * Set the icon of the checkbox.
	 */
	abstract public function withIcon(
		string $icon
	):self;
