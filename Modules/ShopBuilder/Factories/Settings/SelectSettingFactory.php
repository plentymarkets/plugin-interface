...
use Plenty\Modules\ContentBuilder\Factories\Settings\SelectSettingFactory as CoreSelectSettingFactory;

/**
 * Factory to define a selection input in the widget settings.
 */
abstract class SelectSettingFactory 
{

	/**
	 * Set to true to open selection values above the input field.
	 */
	abstract public function withOpenOnTop(
		bool $openOnTop
	):self;
