...
use Plenty\Modules\ContentBuilder\Factories\Settings\TextSettingFactory as CoreTextSettingFactory;

/**
 * Factory to define a text input in the widget settings.
 */
abstract class TextSettingFactory 
{

	/**
	 * Set to true if the input field should be handled as a password input
	 */
	abstract public function withPassword(
		bool $isPassword
	):self;
	 ...
	 */
	abstract public function withReadonly(
		bool $isReadonly
	):self;
